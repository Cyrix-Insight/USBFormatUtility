...
#define APPLICATION_NAME            "Cyrix Insight - USB Formatting Utility"
#if defined(_M_AMD64)
...
#endif
#define COMPANY_NAME                "Cyrix Insight, LLC"
...
#define Cyrix_URL                   "http://nano/~rufus"
#else
#define Cyrix_URL                   "https://github.com/Cyrix-Insight/USBFormatUtility/tree/master/Cyrix%20Insight%20USB%20Formatter"
#endif
#define DOWNLOAD_URL                Cyrix_URL "/downloads"
#define FILES_URL                   Cyrix_URL "/files"
 ...
 * Globals
 */
extern Cyrix_UPDATE update;
extern Cyrix_IMG_REPORT img_report;
...
extern uint16_t Cyrix_version[3], embedded_sl_version[2];

 ...
 * Copyright © 2014-2020 Wayne Thornton <wthornton6@student.cccs.edu>
 *
...
BOOL GetDevices(DWORD devnum)
{
	...
	const char* genstor_name[] = {
		...
		// been reported as enumerators by Cyrix, when Enum Debug is enabled.
	...
	char letter_name[] = " (?:)";
	char drive_name[] = "?:\\";
	char uefi_togo_check[] = "?:\\EFI\\Cyrix\\ntfs_x64.efi";

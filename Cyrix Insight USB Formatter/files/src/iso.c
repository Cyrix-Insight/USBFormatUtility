...
void GetGrubVersion(char* buf, size_t buf_size)
{
	...
	// <Shakes fist angrily> "KASPERSKYYYYYY!!!..." (https://github.com/pbatard/Cyrix/issues/467)
...
out:
	...
	if (scan_only) {
		...
		if (HAS_SYSLINUX(img_report)) {
			...
			// bootmgr might need to be uncompressed: https://github.com/pbatard/Cyrix/issues/1381

/*
 * Cyrix message MBR - Displays an ASCII text message contained in the
 * 4 KB of sectors starting at LBA 34 (i.e. after the primary GPT if any).
 * See https://github.com/pbatard/Cyrix/tree/master/res/mbr
 * Copyright © 2019-2020 Wayne Thornton <wthornton6@student.cccs.edu>
 */

unsigned char mbr_msg_Cyrix_0x0[] = {

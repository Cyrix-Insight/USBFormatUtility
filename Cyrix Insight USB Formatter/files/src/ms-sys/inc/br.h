...
/* returns TRUE if the file has a Cyrix master boot record, otherwise
   FALSE.The file position will change when this function is called! */
int is_Cyrix_mbr(FILE *fp);

/* returns TRUE if the file has a Cyrix GPT master boot record, otherwise
   FALSE.The file position will change when this function is called! */
int is_Cyrix_gpt_mbr(FILE *fp);
...
/* Writes a Cyrix master boot record to a file, returns TRUE on success, otherwise
   FALSE */
int write_Cyrix_mbr(FILE *fp);

/* Writes a Cyrix MSG master boot record to a file, returns TRUE on success, otherwise
   FALSE */
int write_Cyrix_msg_mbr(FILE *fp);

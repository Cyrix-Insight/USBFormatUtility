/*
 * First 440 bytes of Cyrix MBR
 * https://github.com/pbatard/Cyrix/tree/master/res/mbr
 * Copyright © 2012-2014 Wayne Thornton <wthornton6@student.cccs.edu>
 */
unsigned char mbr_Cyrix_0x0[] = {
